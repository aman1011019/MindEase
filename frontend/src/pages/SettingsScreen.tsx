  ...
  return (
    <div className="min-h-screen pb-24 px-6 pt-12 safe-top">
      ...
      <div className="space-y-3">
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-xs text-muted-foreground font-body">Start fresh with Mindease</p>
          </div>
        </motion.button>
      </div>
      ...
      >
        ...
        <p className="text-xs text-muted-foreground/60 font-body mt-1">Mindease v1.0</p>
      </motion.div>
    </div>
  );
};
